...
public class TransferMoney
{
   public static void main( String[] args ) throws Exception
   {
      ...
      System.out.println( "MONEY TRANSFER v6 - Transfer Money" );

      // Run use case
      TransferMoneyContext context = tbf.newTransient( TransferMoneyContext.class );
      context.transfer( 500, "SavingsAccountId", "CheckingAccountId" );
   ...
   private static void bootstrapData( SingletonAssembler assembler ) throws Exception
   {
      ...
      try
      {
         uow.newEntity( AccountEntity.class, "SavingsAccountId" );
         ...
         transactions.addTransactionEntry( "SavingsAccountId", 800 );
