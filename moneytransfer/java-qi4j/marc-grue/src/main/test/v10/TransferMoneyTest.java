...
import v10.api.ContextInjectionProviderFactory;
...
import v10.domain.entity.CheckingAccountEntity;
import v10.domain.entity.SavingsAccountEntity;
import v10.domain.rolemap.BankRolemap;
import v10.domain.rolemap.CheckingAccountRolemap;
import v10.domain.rolemap.CreditorRolemap;
import v10.domain.rolemap.SavingsAccountRolemap;

import static org.qi4j.api.usecase.UsecaseBuilder.newUsecase;
import static v10.api.TemporaryHelper.log;
import static v10.api.TemporaryHelper.setUowf;
...
public class TransferMoneyTest
{
   ...
   public void printBalances()
   {
      ...
      try
      {
         log( SAVINGS_ACCOUNT_ID + ":" + uow.get( BalanceData.class, SAVINGS_ACCOUNT_ID ).getBalance() );
         log( CHECKING_ACCOUNT_ID + ":" + uow.get( BalanceData.class, CHECKING_ACCOUNT_ID ).getBalance() );
         log( CREDITOR_ID1 + ":" + uow.get( BalanceData.class, CREDITOR_ID1 ).getBalance() );
         log( CREDITOR_ID2 + ":" + uow.get( BalanceData.class, CREDITOR_ID2 ).getBalance() );
      }
      finally
      {
         uow.discard();
   ...
   public void transferHalfOfMoneyFromSavingsToChecking() throws Exception
   {
      ...
      try
      {
         ...
         BankData bank = uow.get( BankData.class, BANK );
