...
import v2.api.ContextInjectionProviderFactory;
import v2.domain.context.FrontLoadContext;
import v2.domain.data.ActivityData;
import v2.domain.data.ProjectData;
import v2.domain.entity.ActivityEntity;
import v2.domain.rolemap.ActivityRolemap;
import v2.domain.rolemap.ProjectRolemap;
...
public class FrontloadTest
{
   ...
   public static void setup() throws Exception
   {
      ...
      System.out.println( "FRONTLOADING TESTS - v2 \n========================================================" );
   }
