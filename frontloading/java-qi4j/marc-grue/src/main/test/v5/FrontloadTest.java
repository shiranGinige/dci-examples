...
import v5.api.ContextInjectionProviderFactory;
import v5.domain.data.ActivityData;
import v5.domain.data.ProjectData;
import v5.domain.entity.ActivityEntity;
import v5.domain.rolemap.ProjectRolemap;
...
public class FrontloadTest
{
   ...
   public static void setup() throws Exception
   {
      ...
      System.out.println( "FRONTLOADING TESTS - v5 \n========================================================" );
   }
