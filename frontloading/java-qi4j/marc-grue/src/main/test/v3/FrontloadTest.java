...
import v3.api.ContextInjectionProviderFactory;
import v3.domain.data.ActivityData;
import v3.domain.data.ProjectData;
import v3.domain.entity.ActivityEntity;
import v3.domain.rolemap.ProjectRolemap;
...
public class FrontloadTest
{
   ...
   public static void setup() throws Exception
   {
      ...
      System.out.println( "FRONTLOADING TESTS - v3 \n========================================================" );
   }
