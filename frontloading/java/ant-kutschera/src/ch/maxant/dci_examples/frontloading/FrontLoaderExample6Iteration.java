 ...
 */
public class FrontLoaderExample6Iteration {

	public static class FrontLoad_Context {

		private Project_Data project;
		private BehaviourInjector_ForExample6Iteration bi = new BehaviourInjector_ForExample6Iteration();
	...
	public static class frontLoader_Role {
		...
		public static void doFrontloadingFrom(Date projectStart, IFrontLoader_Role frontLoader) {
