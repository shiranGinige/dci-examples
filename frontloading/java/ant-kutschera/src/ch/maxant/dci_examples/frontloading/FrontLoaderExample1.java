...
/**
 * This example of the frontloader uses simple iteration.  at the point where
 * it needs to cast the child tasks into a list of activities, it casts each on
 * individually, using the {@link CurrentContext}.
 * 
 * @see http://groups.google.com/group/object-composition/browse_thread/thread/9e2b3e28803fca44/aa8a2d7aa2f4a7cb
 */
public class FrontLoaderExample1 {
	...
	public static interface IFrontLoader_Role {
		...
		void doFrontloadingFrom(Date projectStart);
